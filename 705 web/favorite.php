...
<script src="./assets/js/home.js"></script>
 ...
 $stmt = $conn->prepare("SELECT *,t.id as tid FROM favorite t left JOIN files ft ON t.fid = ft.id WHERE t.uid =:id");
   ...
   $stmt->bindParam(':id', $_SESSION['user_id']);
    ...
    <th scope="row"><input class="form-check-input" type="checkbox" value="" id=""></th>
      ...
      <td class="action">
     <a href="fdelete.php?id=<?php echo $v['tid'] ?>"> <i class="fa-regular fa-trash-can" style="color: #5B4795;"></i></a>
